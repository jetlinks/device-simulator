...
@CommandLine.Command(name = "attach", description = "Attach Coap TCP Client")
public class CoapTcpAttachCommand extends ConnectionAttachCommand {
    ...
    static class IdComplete implements Iterable<String> {
        ...
        public Iterator<String> iterator() {
            return ConnectionManager
                    .global()
                    .getConnections()
                    .filter(c -> c.getType() == NetworkType.coap_tcp_client)
    ...
    @CommandLine.Command(name = "request", description = "Send Coap Tcp request")
    @Setter
    ...
    @CommandLine.Command(name = "close", description = "Close TCP Client")
